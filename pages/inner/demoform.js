...
function DemoForm() {
  ...
  const allInfoSubmit = (e) => {
    ...
    axios
      .post("https://admin.nftconstructer.com/api/demo", formData)
      .then((res) => {
  ...
  useEffect(() => {
    fetch("https://admin.nftconstructer.com/api/category")
      .then((res) => res.json())
      .then((result) => {
        setCategory(result);
      });
  ...
  useEffect(() => {
    fetch(
      `https://admin.nftconstructer.com/api/getsubcategory/${inputField.categoryL}`
    )
      .then((res) => res.json())
      .then((result) => {
